...
/// This class provides an input accessory for the terminal on iOS, you can access this via the <code>inputAccessoryView</code>
/// property in the <code>TerminalView</code> and casting the result to <code>TerminalAccessory</code>.
/// This class surfaces some state that the terminal might want to poke at, you should at least support the following
/// properties;
/// <code>controlModifer</code> should be set if the control key is pressed
SWIFT_CLASS("_TtC9SwiftTerm17TerminalAccessory")
@interface TerminalAccessory : UIInputView <UIInputViewAudioFeedback>
...
/// TerminalView provides an AppKit/UIKit front-end to the <code>Terminal</code> terminal emulator.
...
/// Developers might want to surface UIs for <code>optionAsMetaKey</code> which defaults to
...
@interface TerminalView : UIScrollView <UIKeyInput, UIScrollViewDelegate>
...
/// this is an instance of <code>TerminalAccessory</code>
...
@interface TerminalView (SWIFT_EXTENSION(SwiftTerm)) <UITextInput>
...
@property (nonatomic, strong) UITextRange * _Nullable markedTextRange;
...
- (UITextPosition * _Nullable)positionWithinRange:(UITextRange * _Nonnull)range atCharacterOffset:(NSInteger)offset SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)characterOffsetOfPosition:(UITextPosition * _Nonnull)position withinRange:(UITextRange * _Nonnull)range SWIFT_WARN_UNUSED_RESULT;
...
@property (nonatomic, readonly) id _Nonnull insertDictationResultPlaceholder;
- (void)removeDictationResultPlaceholder:(id _Nonnull)placeholder willInsertResult:(BOOL)willInsertResult;
- (void)insertDictationResult:(NSArray<UIDictationPhrase *> * _Nonnull)dictationResult;
